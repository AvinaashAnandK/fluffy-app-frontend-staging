...
import styles from "./modalComps/pricing.module.css";
...
export const tiers: PricingTier[] = [
  {
    ...
    price: { "1": "$0", "2": "$0" },
    discountPrice: { "1": "", "2": "" },
    description: `Best for personal use and hobby projects`,
    features: [
      `Access previously synced public repos`,
      `Upto 5 Chats with Repo`,
      `Sync upto 2 new repos (No size limit)`,
      ``,
    ],
    featured: false,
    highlighted: false,
  ...
  },
  {
    ...
    price: { "1": "$35", "2": "$350" },
    discountPrice: { "1": "", "2": "" },
    description: `Best for more complex coding tasks and professional use`,
    features: [
      `All in the free plan plus`,
      `Sync any number of public repos`,
      `Chat until you 'GET SHIT DONE' `,
      ``,
  ...
  },
  {
    ...
    price: { "1": "$45", "2": "$179.88" },
    discountPrice: { "1": "", "2": "" },
    description: `As you grow, need more power and flexibility.`,
    features: [
      `All in pro plan plus`,
      `Sync private repos`,
      `Sync branches in repos`,
      `Early access to new features`,
    ],
    featured: false,
    highlighted: true,
            ...
            <div className="w-full flex flex-col items-center">
              <div className="mx-auto max-w-7xl px-6 lg:px-8 flex flex-col items-center">
                <div className="w-full lg:w-auto mx-auto max-w-4xl lg:text-center">
                  <h1 className="text-black dark:text-white text-xl font-semibold max-w-xs sm:max-w-none md:text-3xl !leading-tight">
                    Pricing
                  </h1>
