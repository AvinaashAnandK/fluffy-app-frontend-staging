...
export const TripleInputChatPanel = ({ inputValue, setInputValue, onFormSubmit, formRef, onKeyDown, inputRef, chatRepoTasks, inputValue2, setInputValue2, inputValue3, setInputValue3, isSubmitting, setIsSubmitting }: InputChatPanelDefaultProps) => {
  ...
  return (
    <div className="sticky pt-10 inset-x-0 bottom-0 w-full bg-gradient-to-b duration-300 ease-in-out animate-in dark:from-background/10 dark:from-10% peer-[[data-state=open]]:group-[]:lg:pl-[250px] peer-[[data-state=open]]:group-[]:xl:pl-[300px]] mb-4">
      ...
      <div className="px-4 py-2 space-y-4 border-t shadow-lg bg-background sm:rounded-t-xl sm:border md:py-4">
          ...
          <div className='flex flex-row'>
            ...
            <div className="sm:right-4">
              <Button type="submit" size="icon" disabled={inputValue.trim() === '' || inputValue2.trim() === '' || inputValue3.trim() === '' || isSubmitting}>
                  <IconArrowElbow />
