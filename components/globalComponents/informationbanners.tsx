...
export const ApproachGenerated = () => {
    return ( 
        <div className="h-full pt-2 p-10 flex flex-col items-center justify-center">
            <aside className="bg-primary/10 text-white p-6 rounded-lg w-full max-w-lg font-mono">
...
export const ExploreModelFirst = () => {
    return ( 
        <div className="h-full pt-10 p-10 flex flex-col items-center justify-center">
            ...
            <div className="mt-4">
                <p className="text-green-400">Search for ECG models in Healthcare</p>
                <p className="text-white">or</p>
                <p className="text-green-400">Search for Classification in Image Analysis</p>
            </div>
            </aside>
        </div>
     );
