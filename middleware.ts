...
const publicRoutes = [
      ...
      "/api/dboperations/purchaseHistory/fetchStripeCustomerId",
      "/api/dboperations/purchaseHistory/updatePurchase",
      "/api/dboperations/purchaseHistory/createPurchase",
      "/api/dboperations/purchaseHistory/fetchCurrentSubscription",
      "/api/webhook",
      "/api/fetchsources",
